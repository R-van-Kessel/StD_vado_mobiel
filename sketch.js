...
function createNavigation() {
  ...
  nav.className = 'nav';
  nav.innerHTML = `
    <a href="https://r-van-kessel.github.io/Summon_the_Dragon/">🏠</a>
    <a href="https://r-van-kessel.github.io/Summon_the_Dragon/rekenen.html">➗</a>
    <a href="https://r-van-kessel.github.io/Summon_the_Dragon/klas1.html">📘</a>
    <a href="https://r-van-kessel.github.io/Summon_the_Dragon/klas2.html">📗</a>
    <a href="https://r-van-kessel.github.io/Summon_the_Dragon/klas3.html">📙</a>
    <a href="https://r-van-kessel.github.io/Summon_the_Dragon/bovenbouw.html">🎓</a>
  `;
...
function setup() {
    ...
    SCALE_FACTOR = 1; // We gaan NIET schalen, maar responsive maken
    
    console.log("Setup - IS_MOBILE:", IS_MOBILE);
    console.log("Setup - Window width:", window.innerWidth);
    console.log("Setup - User agent:", navigator.userAgent);
    ...
    // BUTTONS - relatieve positionering
    let buttonContainer = createDiv();
    buttonContainer.parent(container);
    buttonContainer.style('display', 'flex');
    buttonContainer.style('gap', IS_MOBILE ? '5px' : '10px');
    ...
    let btnPadding = IS_MOBILE ? '8px 10px' : '10px 15px';
    let btnFontSize = IS_MOBILE ? '12px' : '16px';
