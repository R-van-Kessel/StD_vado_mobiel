...
function setup() {
    ...
    // Button container BOVEN canvas (niet absoluut, maar in flow)
    let buttonContainer = createDiv();
    buttonContainer.parent(wrapper); // Parent is wrapper, niet container!
    ...
    buttonContainer.style('order', '1'); // Komt voor canvas (canvas heeft order 2)
   
    let btnPadding = IS_MOBILE ? '5px 8px' : '10px 15px';
    let btnFontSize = IS_MOBILE ? '11px' : '16px';
