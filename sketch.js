...
function setup() {
    ...
    buttonContainer.parent(wrapper);
    ...
    buttonContainer.style('order', '1'); // Komt eerst
    ...
    // VERPLAATS BUTTONS NAAR BOVEN CANVAS (maar canvas tekent titel zelf)
    // We moeten de buttons OVER het canvas positioneren
