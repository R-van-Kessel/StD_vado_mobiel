...
const IS_MOBILE = (function() {
  ...
  // Check viewport width (gebruik innerWidth van window)
...
console.log("IS_MOBILE detectie:", IS_MOBILE);
console.log("User Agent:", navigator.userAgent);
console.log("Window width:", window.innerWidth);

const SCALE_FACTOR = IS_MOBILE ? 0.7 : 1;
...
function setup() {
  ...
  // DEBUG INFO
    ...
    console.log("Setup - Canvas dimensions:", canvasWidth, canvasHeight);
    ...
    if (IS_MOBILE) {
        ...
        cnv.elt.style.transformOrigin = 'top center';
        container.elt.style.height = (canvasHeight * SCALE_FACTOR) + 'px';
    }
