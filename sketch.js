...
function setup() {
    ...
    // Voor mobiel: schaal canvas naar viewport breedte
    if (IS_MOBILE) {
        let viewportWidth = window.innerWidth - 40; // 20px padding links en rechts
        SCALE_FACTOR = viewportWidth / canvasWidth;
        SCALE_FACTOR = min(SCALE_FACTOR, 1); // Niet groter dan origineel
        
        canvasWidth = canvasWidth * SCALE_FACTOR;
        canvasHeight = canvasHeight * SCALE_FACTOR;
    }
    ...
    checkButton.position((MARGIN + BUTTON_1_X) * SCALE_FACTOR, BUTTON_Y * SCALE_FACTOR);
    ...
    scoreButton.position((MARGIN + BUTTON_2_X) * SCALE_FACTOR, BUTTON_Y * SCALE_FACTOR);
    
    resetButton = createButton('Reset');
    resetButton.parent(container);
    resetButton.mousePressed(resetGame);
    styleButton(resetButton, '#f44336', '10px 15px');
    resetButton.position((MARGIN + BUTTON_3_X) * SCALE_FACTOR, BUTTON_Y * SCALE_FACTOR);
    ...
    infoButton.position((MARGIN + BUTTON_4_X) * SCALE_FACTOR, BUTTON_Y * SCALE_FACTOR);
