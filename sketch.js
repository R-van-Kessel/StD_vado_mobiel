...
function setup() {
    ...
    checkButton.style('font-size', IS_MOBILE ? '14px' : '16px');
    ...
    scoreButton.style('font-size', IS_MOBILE ? '14px' : '16px');
    ...
    resetButton.style('font-size', IS_MOBILE ? '14px' : '16px');
    ...
    infoButton.style('font-size', IS_MOBILE ? '14px' : '16px');
