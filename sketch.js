...
function setup() {
    ...
    if (IS_MOBILE) {
        ...
        SCALE_FACTOR = constrain(SCALE_FACTOR, 0.3, 1.2); // Minimum 40%, maximum 100%
    } else {
        SCALE_FACTOR = 1;
    }
    ...
    // Voorkom alleen selectie, maar sta touch toe
    cnv.elt.style.touchAction = 'pan-y pinch-zoom';  // Sta scrollen en zoomen toe
